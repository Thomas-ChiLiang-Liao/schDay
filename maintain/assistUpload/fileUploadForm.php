...
$statement->bindParam(':name',$_POST['facultyName'],PDO::PARAM_STR, 45);
$statement->execute();
?>
				...
				<div class="col-12 col-sm-10 offset-sm-1 col-lg-8 offset-lg-2 col-xl-6 offset-xl-3">
					<div class="card mt-3">
						<div class="card-header bg-primary">
							<h3 class="text-center text-white"><?php echo $_POST['facultyName'];?>老師<?php echo substr($SEMESTER,0,3) . ' 學年度第 ' . substr($SEMESTER,-1);?> 學期授課課程如下：</h3>
						</div>
								...
								<tbody>								  
									...
									<tr>
										...
										if (file_exists("../../files/$SEMESTER/$course[currArrId].pdf")) {
                                            $path = "https:../../files/index.php?s=$SEMESTER&fileName=$course[currArrId]&class=$course[classTitle]&subject=$course[subjectTitle]&teacher=$_POST[facultyName]";
											?>
