...
if ( !isset( $_SERVER['HTTPS'] ) OR ( $_SERVER['HTTPS'] != 'on' ) ) header("Location: https://$_SERVER[SERVER_NAME]" . dirname( $_SERVER['SCRIPT_NAME'] . '/' ) );
	...
	$statement = $pdo->query('SELECT id, name FROM operator WHERE currArrRole = 1;');
	$statement->execute();
?>
  	...
  	<div class="container-fluid">
    	<div class="row d-none d-sm-block">
    		<div class="col-12 m-0 pt-3 pb-1 bg-warning">
					<h3 class="text-center">大安高工校園輔助系統</h3>
    		</div>
    	</div>
     	<div class="row mt-5">
    						...
    						<input type="hidden" id="userId" name="userId">
 								<div class="input-group">
 									<div class="input-group-prepend">
 	 								...
 	 								<input type="text" class="form-control" placeholder="請輸入姓名" list="operators" name="userName" id="userName" onpaste="return false;">
 									<datalist id="operators">
 										<?php/* while ($record = $statement->fetch(PDO::FETCH_ASSOC)) echo "<option data-value='$record[id]' value='$record[name]'>";*/ ?>
 										<option value="呂頌恩" data-value="0023"></option>
                    <option value="莊政道" data-value="0081"></option>
 										<option value="林冠宇" data-value="0083"></option>
 										<option value="廖啟良" data-value="0133"></option>
                    <option value="蕭為康" data-value="0135"></option>
                    <option value="鄧宇超" data-value="0164"></option>
 									</datalist>
 								</div>
